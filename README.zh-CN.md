...
| Locale | 状态 |
| --- | --- |
| `zh-cn` 简体中文 | 已发布——编辑器主体译文 + Kiro 专有文案 1365 条全覆盖（100%） |
...
已对齐 Kiro **1.1.14**（Code OSS 1.131.0）、**1.0.437**、**1.0.395**、**1.0.309**（Code OSS 1.109.5）、**1.0.242**（Code OSS 1.108.2）与 **1.0.228**，见
