...
| Locale | Status |
| --- | --- |
| `zh-cn` 简体中文 | Shipped — workbench baseline plus all 1365 Kiro-specific strings (100%) |
...
Reconciled against Kiro **1.1.14** (Code OSS 1.131.0), **1.0.437**, **1.0.395** and **1.0.309** (Code OSS 1.109.5), **1.0.242** (Code OSS 1.108.2)
